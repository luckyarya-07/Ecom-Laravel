...
<body>
    ...
    <div class="preloader"></div>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="/dashbord">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li class="@yield('active_class')">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('category_class')">
                            <a href="{{ route('category.index') }}">
                                <i class="fas fa-chart-bar"></i>Category</a>
                        </li>
                        <li class="@yield('coupan_class')">
                            <a href="{{ route('coupan.index') }}">
                                <i class="fas fa-tags"></i>Coupans</a>
                        </li>
                        <li class="@yield('productCat_class')">
                            <a href="{{ route('product-category.index') }}">
                                <i class="fas fa-tags"></i>Product Category</a>
                        </li>
                        <li class="@yield('products_class')">
        ...
        <div class="page-container">
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="/user/account/name/{{ Auth::user()->name }}">
                                                    @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                                    <img src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" />
                                                    @endif
                                                    </a>
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="/user/account/name/{{ Auth::user()->name }}">{{ Auth::user()->name }}</a>
                                                    </h5>
            ...
            <!-- MAIN CONTENT-->
            <div class="main-content p-r-30 p-l-30">
             @section('container')
             @show
            </div>
